...
gdjs.evtsExt__CountdownTimer__InitialConfigurationValue.idToCallbackMap = new Map();
...
{
{eventsFunctionContext.returnValue = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__CountdownTimer").getChild("Clocks").getChild(eventsFunctionContext.getArgument("ClockName")).getChild("TimeRestart"));}
}
